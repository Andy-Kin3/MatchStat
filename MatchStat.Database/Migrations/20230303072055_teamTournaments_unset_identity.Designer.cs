...
namespace MatchStat.DataModel.Migrations
{
    ...
    [Migration("20230303072055_teamTournaments_unset_identity")]
    partial class teamTournaments_unset_identity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MatchStat.DataModel.DataModels.Fields", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("ID");
            ...
            modelBuilder.Entity("MatchStat.DataModel.DataModels.Matches", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int")
                        .HasColumnName("ID");
            ...
            modelBuilder.Entity("MatchStat.DataModel.DataModels.Matches", b =>
                {
                    b.HasOne("MatchStat.DataModel.DataModels.Fields", "Field")
                        .WithMany("Matches")
